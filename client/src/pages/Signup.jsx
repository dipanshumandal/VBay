    ...
    <div className='mt-20 sm:mt-10 min-h-screen flex items-center justify-center w-full'>
      ...
      <form>
        ...
        <div className='mb-4'>
          ...
          <input type='text' name='name' id="name" placeholder='Name' className='shadow-md rounded-md w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-black focus:border-black'/>
        </div>
        {/* For Email */}
        <div className='mb-4'>
