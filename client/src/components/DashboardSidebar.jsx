          ...
          {pathname === "/seller/profile" ? (
            <li
              className={`w-full rounded-lg px-2 hover:bg-black hover:text-white cursor-pointer transition-all ease-linear duration-300 hover:scale-105 flex gap-2 justify-start items-center ${
                tab === "product-management" && "bg-black text-white"
              }`}
              onClick={() => dispatch(setTab("product-management"))}
            >
              <IoMdPhotos /> Manage Products
            </li>
          ) : (
            <li
              className={`w-full rounded-lg px-2 hover:bg-black hover:text-white cursor-pointer transition-all ease-linear duration-300 hover:scale-105 flex gap-2 justify-start items-center ${
                tab === "product-purchased" && "bg-black text-white"
              }`}
              onClick={() => dispatch(setTab("product-purchased"))}
            >
              <IoMdPhotos /> Products Purchased
            </li>
          )}
